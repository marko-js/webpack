...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/__tests__/fixtures/with-public-path/server.js");
/******/ })
/************************************************************************/
/******/ ({
...
_marko_template._ = marko_dist_runtime_components_renderer__WEBPACK_IMPORTED_MODULE_6___default()(function (input, out, _component, component, state) {
  ...
  const newAssets = _marko_webpack_loader_manifest__WEBPACK_IMPORTED_MODULE_2__["default"].getAssets("test_xGHm", out.global.buildName);
