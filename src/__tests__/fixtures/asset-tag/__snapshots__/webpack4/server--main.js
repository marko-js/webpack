...
/* harmony import */ var marko_dist_runtime_html_helpers_merge_attrs_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! marko/dist/runtime/html/helpers/merge-attrs.js */ "marko/dist/runtime/html/helpers/merge-attrs.js");
/* harmony import */ var marko_dist_runtime_html_helpers_merge_attrs_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(marko_dist_runtime_html_helpers_merge_attrs_js__WEBPACK_IMPORTED_MODULE_2__);
...
_marko_template._ = marko_dist_runtime_components_renderer_js__WEBPACK_IMPORTED_MODULE_3___default()(function (input, out, _componentDef, _component, state, $global) {
  ...
  if (assets.js) {
    ...
    for (const js of assets.js || []) {
      ...
      if (!written.has(js)) {
        written.add(js);
        out.w(`<script${marko_dist_runtime_html_helpers_merge_attrs_js__WEBPACK_IMPORTED_MODULE_2___default()({
  ...
  if (assets.css) {
    ...
    for (const css of assets.css || []) {
      ...
      if (!written.has(css)) {
        written.add(css);
        out.w(`<link${marko_dist_runtime_html_helpers_merge_attrs_js__WEBPACK_IMPORTED_MODULE_2___default()({
          "rel": "stylesheet",
