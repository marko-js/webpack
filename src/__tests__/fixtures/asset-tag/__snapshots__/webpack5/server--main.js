  ...
  if (assets.js) {
    ...
    for (const js of assets.js) {
      ...
      if (!written.has(js)) {
        ...
        if (inline) {
          marko_dist_runtime_helpers_render_tag__WEBPACK_IMPORTED_MODULE_7___default()((marko_dist_core_tags_core_await_renderer_js__WEBPACK_IMPORTED_MODULE_6___default()), {
            "_provider": fs_promises__WEBPACK_IMPORTED_MODULE_1___default().readFile(outputPath + js, "utf-8"),
  ...
  if (assets.css) {
    ...
    for (const css of assets.css) {
      ...
      if (!written.has(css)) {
        ...
        if (inline) {
          marko_dist_runtime_helpers_render_tag__WEBPACK_IMPORTED_MODULE_7___default()((marko_dist_core_tags_core_await_renderer_js__WEBPACK_IMPORTED_MODULE_6___default()), {
            "_provider": fs_promises__WEBPACK_IMPORTED_MODULE_1___default().readFile(outputPath + css, "utf-8"),
